...
namespace Infrastructure.Data
{
    ...
    new Event
    {
        ...
        Text2 = null,
        EventCreated = new DateTime(2024, 11, 1, 9, 0, 0, DateTimeKind.Utc),
        EventDate = new DateTime(2025, 12, 2),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 9),
        StartTime = new TimeSpan(10, 0, 0),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 3),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 17),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 4),
        StartTime = new TimeSpan(9, 0, 0),
        EndTime = new TimeSpan(12, 0, 0),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 11),
        StartTime = new TimeSpan(13, 0, 0),
        EndTime = new TimeSpan(16, 0, 0),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 18),
        StartTime = new TimeSpan(10, 0, 0),
        EndTime = new TimeSpan(12, 30, 0),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 6),
    ...
    new Event
    {
        ...
        EventDate = new DateTime(2025, 12, 13),
        StartTime = new TimeSpan(17, 30, 0),
